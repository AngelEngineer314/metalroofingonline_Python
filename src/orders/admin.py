...
class OrderAdmin(admin.ModelAdmin):
    list_per_page = 20
    list_display = ('timestamp', 'order_id', 'name', 'delivery_date', 'suburb', 'total', 'status', 'store', 'site',
                    'flash', 'pack', 'supplier_eta', 'customer_eta', 'tracking_number', 'email_status',
                    'account_actions')
    list_editable = ('status', 'supplier_eta',
                     'customer_eta', 'tracking_number', 'email_status')
    ...
    def get_urls(self):
        ...
        custom_urls = [
            ...
            re_path(
                r'(?P<order_id>.+)/invoice-priceless/$',
